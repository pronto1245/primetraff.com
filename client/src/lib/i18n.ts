...
export const translations = {
  ...
  landingPage: {
    ...
    aboutParas: {
      ru: [
        "PrimeTraff — iGaming-сеть, где каждый партнёр работает с реальной поддержкой, а не просто с личным кабинетом.",
        "Рекламодатели получают верифицированный трафик, вебы — честные условия и быстрый запуск.",
        "Фрод не проходит: каждый источник проверяется до старта и контролируется на всём пути.",
        "Мы не набираем всех подряд — сеть растёт за счёт партнёров, которые дают результат.",
        "Наша модель простая: сильные условия, прозрачная работа, выплаты в срок.",
      ],
      en: [
        "PrimeTraff is an iGaming network where every partner gets real support, not just a dashboard.",
        "Advertisers get verified traffic, webmasters get fair terms and a fast launch.",
        "Fraud doesn't pass: every source is checked before launch and monitored throughout.",
        "We don't take everyone — the network grows through partners who deliver results.",
        "Our model is simple: strong terms, transparent work, payments on time.",
      ],
    },
  ...
  affiliatesPage: {
    ...
    whyParas: {
      ru: [
        "Решаем ключевые вопросы за тебя — ставки, холды, предоплата и условия рекламодателей на нашей стороне.",
        "Каждого рекламодателя проверяем до старта — работаем только с теми, кто платит честно и в срок.",
        "Ты приводишь трафик — мы делаем всё остальное, чтобы ты получил за него максимум.",
      ],
      en: [
        "We handle key issues for you — rates, holds, prepayment, and advertiser terms are on our side.",
        "We verify every advertiser before launch — we only work with those who pay honestly and on time.",
        "You bring the traffic — we do everything else to make sure you get the maximum for it.",
      ],
    },
