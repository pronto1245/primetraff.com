...
export default function LandingPage() {
  ...
  return (
    <div style={{ width: '100%', fontFamily: FONT }} className="bg-black text-white">
      ...
      {/* ===== ABOUT + PARTNERS ===== */}
      <section className="snap-sec relative bg-black flex flex-col" style={{ minHeight: '100vh', paddingTop: 'clamp(60px, 8vh, 100px)', paddingLeft: PAD, paddingRight: PAD, paddingBottom: '40px' }}>
