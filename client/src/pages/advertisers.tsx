...
export default function AdvertisersPage() {
  ...
  return (
    <div style={{ width: '100%', fontFamily: FONT }} className="bg-black text-white">
      ...
      {/* ===== DISCUSS COOPERATION ===== */}
      <section className="snap-sec sec-fade relative bg-black flex flex-col justify-between overflow-hidden" style={{ minHeight: '100vh', padding: `clamp(50px, 8vh, 90px) ${PAD} clamp(16px, 2.5vh, 28px)` }}>
        <ScrollHint />
        <div className="absolute inset-0 z-0">
      ...
      {/* ===== FAQ ===== */}
      <section id="faq" className="no-snap sec-fade relative bg-black flex flex-col justify-between" style={{ minHeight: '100vh', padding: `clamp(50px, 8vh, 90px) ${PAD} clamp(16px, 2.5vh, 28px)` }}>
